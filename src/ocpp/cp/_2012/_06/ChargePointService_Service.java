 ...
 * 
 */
@WebServiceClient(name = "ChargePointService", targetNamespace = "urn://Ocpp/Cp/2012/06/", wsdlLocation = "META-INF/wsdl/ocpp_chargepointservice_1.5_final.wsdl")
    ...
    extends Service
{
    ...
    static {
        CHARGEPOINTSERVICE_WSDL_LOCATION = ocpp.cp._2012._06.ChargePointService_Service.class.getClassLoader().getResource("META-INF/wsdl/ocpp_chargepointservice_1.5_final.wsdl");
        WebServiceException e = null;
        if (CHARGEPOINTSERVICE_WSDL_LOCATION == null) {
            e = new WebServiceException("Cannot find 'META-INF/wsdl/ocpp_chargepointservice_1.5_final.wsdl' wsdl. Place the resource correctly in the classpath.");
        }
