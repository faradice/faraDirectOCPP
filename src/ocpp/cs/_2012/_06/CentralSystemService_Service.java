 ...
 * 
 */
@WebServiceClient(name = "CentralSystemService", targetNamespace = "urn://Ocpp/Cs/2012/06/", wsdlLocation = "META-INF/wsdl/ocpp_centralsystemservice_1.5_final.wsdl")
    ...
    extends Service
{
    ...
    static {
        CENTRALSYSTEMSERVICE_WSDL_LOCATION = ocpp.cs._2012._06.CentralSystemService_Service.class.getClassLoader().getResource("META-INF/wsdl/ocpp_centralsystemservice_1.5_final.wsdl");
        WebServiceException e = null;
        if (CENTRALSYSTEMSERVICE_WSDL_LOCATION == null) {
            e = new WebServiceException("Cannot find 'META-INF/wsdl/ocpp_centralsystemservice_1.5_final.wsdl' wsdl. Place the resource correctly in the classpath.");
        }
